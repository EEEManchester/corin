...
if __name__ == "__main__":
	...
	if len(sys.argv) > 1:
		if sys.argv[1] == 'fault':
			...
			pose_yaw 	= 0.
			qb = [pose_x, pose_y, pose_z, pose_roll, pose_pitch, pose_yaw]
			qd = [ 0.6981317,   0.6939246 , -2.03135032,  0.       ,   0.6939246 , -2.03135032,
				  -0.6981317,   0.6939246 , -2.03135032, -0.6981317,   0.81969609, -1.22860141,
				   0.       ,   0.81969609, -1.22860141,  0.6981317,   0.81969609, -1.22860141]
