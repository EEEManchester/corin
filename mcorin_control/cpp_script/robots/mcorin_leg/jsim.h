#ifndef IIT_MCORIN_LEG_JSIM_H_
#define IIT_MCORIN_LEG_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot MCORIN_LEG.
 */
class JSIM : public iit::rbd::StateDependentMatrix<iit::MCORIN_LEG::JointState, 3, 3, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<iit::MCORIN_LEG::JointState, 3, 3, JSIM> Base;
    public:
