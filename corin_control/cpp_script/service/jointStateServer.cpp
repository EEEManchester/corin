#include "ros/ros.h"
#include "mcorin_control/JointState.h"
#include "mcorin_control/Imu.h"
...
bool getJointState(mcorin_control::JointState::Request  &req,
                    mcorin_control::JointState::Response &res)
{
...
bool getGzImuState(mcorin_control::Imu::Request  &req,
                    mcorin_control::Imu::Response &res)
{
...
bool getAhImuState(mcorin_control::Imu::Request  &req,
                    mcorin_control::Imu::Response &res)
{
