#ifndef IIT_ROBOT_SLM_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_SLM_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot SLM.
 *
...
public:
     ...
     *     the robot SLM, which will be used by this instance
