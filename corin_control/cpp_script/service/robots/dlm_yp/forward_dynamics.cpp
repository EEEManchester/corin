...
const iit::DLM_YP::dyn::ForwardDynamics::ExtForces
    iit::DLM_YP::dyn::ForwardDynamics::zeroExtForces(Force::Zero());

iit::DLM_YP::dyn::ForwardDynamics::ForwardDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void iit::DLM_YP::dyn::ForwardDynamics::fd(
    JointState& qdd,
    const JointState& qd,
