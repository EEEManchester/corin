#ifndef DLM_YP_TRANSFORMS_H_
#define DLM_YP_TRANSFORMS_H_
...
typedef iit::DLM_YP::JointState state_t;
...
public:
    class Type_fr_base_X_fr_l2 : public TransformMotion<Type_fr_base_X_fr_l2>
    {
    public:
        Type_fr_base_X_fr_l2();
        const Type_fr_base_X_fr_l2& update(const state_t&);
    protected:
    };
...
public:
    ...
    Type_fr_base_X_fr_l2 fr_base_X_fr_l2;
...
public:
    class Type_fr_base_X_fr_l2 : public TransformForce<Type_fr_base_X_fr_l2>
    {
    public:
        Type_fr_base_X_fr_l2();
        const Type_fr_base_X_fr_l2& update(const state_t&);
...
public:
    class Type_fr_base_X_fr_l2 : public TransformHomogeneous<Type_fr_base_X_fr_l2>
    {
    public:
        Type_fr_base_X_fr_l2();
        const Type_fr_base_X_fr_l2& update(const state_t&);
