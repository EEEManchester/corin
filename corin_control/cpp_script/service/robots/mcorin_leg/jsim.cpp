...
iit::MCORIN_LEG::dyn::JSIM::JSIM(InertiaProperties& inertiaProperties, ForceTransforms& forceTransforms) :
...
const iit::MCORIN_LEG::dyn::JSIM& iit::MCORIN_LEG::dyn::JSIM::update(const JointState& state) {
...
void iit::MCORIN_LEG::dyn::JSIM::computeL() {
...
void iit::MCORIN_LEG::dyn::JSIM::computeInverse() {
    computeLInverse();
...
void iit::MCORIN_LEG::dyn::JSIM::computeLInverse() {
