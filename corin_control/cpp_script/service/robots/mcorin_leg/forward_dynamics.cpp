...
const iit::MCORIN_LEG::dyn::ForwardDynamics::ExtForces
    iit::MCORIN_LEG::dyn::ForwardDynamics::zeroExtForces(Force::Zero());

iit::MCORIN_LEG::dyn::ForwardDynamics::ForwardDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void iit::MCORIN_LEG::dyn::ForwardDynamics::fd(
    JointState& qdd,
    const JointState& qd,
