...
using namespace iit::MCORIN_LEG::dyn;

// Initialization of static-const data
const iit::MCORIN_LEG::dyn::InverseDynamics::ExtForces
iit::MCORIN_LEG::dyn::InverseDynamics::zeroExtForces(Force::Zero());

iit::MCORIN_LEG::dyn::InverseDynamics::InverseDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
    ...
    {
#ifndef EIGEN_NO_DEBUG
    std::cout << "Robot MCORIN_LEG, InverseDynamics::InverseDynamics()" << std::endl;
...
void iit::MCORIN_LEG::dyn::InverseDynamics::id(
    JointState& jForces,
...
void iit::MCORIN_LEG::dyn::InverseDynamics::G_terms(JointState& jForces)
{
    // Link 'l1'
...
void iit::MCORIN_LEG::dyn::InverseDynamics::C_terms(JointState& jForces, const JointState& qd)
{
    // Link 'l1'
...
void iit::MCORIN_LEG::dyn::InverseDynamics::firstPass(const JointState& qd, const JointState& qdd, const ExtForces& fext)
{
    // First pass, link 'l1'
    l1_a = (xm->fr_l1_X_fr_base).col(iit::rbd::LZ) * iit::rbd::g;
...
void iit::MCORIN_LEG::dyn::InverseDynamics::secondPass(JointState& jForces)
{
    // Link 'l3'
