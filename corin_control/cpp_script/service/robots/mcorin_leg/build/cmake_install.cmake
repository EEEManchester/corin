...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/include/iit/robots/mcorin_leg/declarations.h;/usr/local/include/iit/robots/mcorin_leg/link_data_map.h;/usr/local/include/iit/robots/mcorin_leg/joint_data_map.h;/usr/local/include/iit/robots/mcorin_leg/transforms.h;/usr/local/include/iit/robots/mcorin_leg/kinematics_parameters.h;/usr/local/include/iit/robots/mcorin_leg/jacobians.h;/usr/local/include/iit/robots/mcorin_leg/traits.h;/usr/local/include/iit/robots/mcorin_leg/jsim.h;/usr/local/include/iit/robots/mcorin_leg/inverse_dynamics.h;/usr/local/include/iit/robots/mcorin_leg/forward_dynamics.h;/usr/local/include/iit/robots/mcorin_leg/inertia_properties.h;/usr/local/include/iit/robots/mcorin_leg/dynamics_parameters.h;/usr/local/include/iit/robots/mcorin_leg/miscellaneous.h")
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libiitgenmcorin_leg.so" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/lib/libiitgenmcorin_leg.so"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/lib/libiitgenmcorin_leg.so")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/wilson/catkin_ws/src/corin/corin_control/cpp_script/robots/mcorin_leg/build/libiitgenmcorin_leg.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libiitgenmcorin_leg.so" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/lib/libiitgenmcorin_leg.so")
    endif()
  endif()
endif()
