#ifndef IIT_LCORIN_LEG_INVERSE_DYNAMICS_H_
#define IIT_LCORIN_LEG_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot LCORIN_LEG.
 *
...
public:
     ...
     *     the robot LCORIN_LEG, which will be used by this instance
...
public:
    ...
    const Velocity& getVelocity_l3() const { return l3_v; }
    const Acceleration& getAcceleration_l3() const { return l3_a; }
    const Force& getForce_l3() const { return l3_f; }
    ///@}
protected:
