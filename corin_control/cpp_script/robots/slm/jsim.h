#ifndef IIT_SLM_JSIM_H_
#define IIT_SLM_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot SLM.
 */
class JSIM : public iit::rbd::StateDependentMatrix<iit::SLM::JointState, 1, 1, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<iit::SLM::JointState, 1, 1, JSIM> Base;
    public:
