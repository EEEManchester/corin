#ifndef MCORIN_LEG_TRANSFORMS_H_
#define MCORIN_LEG_TRANSFORMS_H_
...
typedef iit::MCORIN_LEG::JointState state_t;
...
public:
    ...
    class Type_fr_base_X_l1_COM : public TransformMotion<Type_fr_base_X_l1_COM>
    {
    public:
        Type_fr_base_X_l1_COM();
        const Type_fr_base_X_l1_COM& update(const state_t&);
    protected:
    };
    
    class Type_fr_base_X_l2_COM : public TransformMotion<Type_fr_base_X_l2_COM>
    {
    public:
        Type_fr_base_X_l2_COM();
        const Type_fr_base_X_l2_COM& update(const state_t&);
    protected:
    };
    
    class Type_fr_base_X_l3_COM : public TransformMotion<Type_fr_base_X_l3_COM>
    {
    public:
        Type_fr_base_X_l3_COM();
        const Type_fr_base_X_l3_COM& update(const state_t&);
    protected:
    };
...
public:
    ...
    Type_fr_base_X_l1_COM fr_base_X_l1_COM;
    Type_fr_base_X_l2_COM fr_base_X_l2_COM;
    Type_fr_base_X_l3_COM fr_base_X_l3_COM;
...
public:
    ...
    class Type_fr_base_X_l1_COM : public TransformForce<Type_fr_base_X_l1_COM>
    {
    public:
        Type_fr_base_X_l1_COM();
        const Type_fr_base_X_l1_COM& update(const state_t&);
    ...
    class Type_fr_base_X_l2_COM : public TransformForce<Type_fr_base_X_l2_COM>
    {
    public:
        Type_fr_base_X_l2_COM();
        const Type_fr_base_X_l2_COM& update(const state_t&);
    ...
    class Type_fr_base_X_l3_COM : public TransformForce<Type_fr_base_X_l3_COM>
    {
    public:
        Type_fr_base_X_l3_COM();
        const Type_fr_base_X_l3_COM& update(const state_t&);
...
public:
    ...
    class Type_fr_base_X_l1_COM : public TransformHomogeneous<Type_fr_base_X_l1_COM>
    {
    public:
        Type_fr_base_X_l1_COM();
        const Type_fr_base_X_l1_COM& update(const state_t&);
    ...
    class Type_fr_base_X_l2_COM : public TransformHomogeneous<Type_fr_base_X_l2_COM>
    {
    public:
        Type_fr_base_X_l2_COM();
        const Type_fr_base_X_l2_COM& update(const state_t&);
    ...
    class Type_fr_base_X_l3_COM : public TransformHomogeneous<Type_fr_base_X_l3_COM>
    {
    public:
        Type_fr_base_X_l3_COM();
        const Type_fr_base_X_l3_COM& update(const state_t&);
