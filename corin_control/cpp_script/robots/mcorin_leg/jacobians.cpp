...
iit::MCORIN_LEG::Jacobians::Jacobians
    ()
     : 
    fr_base_J_ee()
{
...
void iit::MCORIN_LEG::Jacobians::updateParameters() {
}


iit::MCORIN_LEG::Jacobians::Type_fr_base_J_ee::Type_fr_base_J_ee()
{
    (*this)(0,0) = 0;
    (*this)(1,0) = 0;
    (*this)(2,0) = 1.0;
...
const iit::MCORIN_LEG::Jacobians::Type_fr_base_J_ee& iit::MCORIN_LEG::Jacobians::Type_fr_base_J_ee::update(const JointState& jState) {
