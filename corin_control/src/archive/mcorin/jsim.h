#ifndef IIT_MCORIN_JSIM_H_
#define IIT_MCORIN_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot mcorin.
 */
class JSIM : public iit::rbd::StateDependentMatrix<iit::mcorin::JointState, 24, 24, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<iit::mcorin::JointState, 24, 24, JSIM> Base;
    public:
        typedef Base::Scalar Scalar;
        typedef Base::Index Index;
        typedef Eigen::Matrix<double,24,24> MatrixType;
        /** The type of the F sub-block of the floating-base JSIM */
        typedef const Eigen::Block<const MatrixType,6,18> BlockF_t;
        /** The type of the fixed-base sub-block of the JSIM */
        typedef const Eigen::Block<const MatrixType,18,18> BlockFixedBase_t;
    public:
         ...
         * \return the 6x18 upper right block of this JSIM
         */
         ...
         * \return the 18x18 lower right block of this JSIM,
