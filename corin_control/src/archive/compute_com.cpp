...
#include "mcorin/declarations.h"
// #include "mcorin/transforms.h"
...
static PyObject *
compute_com(PyObject *self, PyObject *args) {
    PyObject* p(NULL);
    PyObject* item(NULL);    
    ...
    try{
        ...
        std::string msg = ("compute_com failed: ");
        msg += e.what();
...
static PyMethodDef EigenMethods[] = {
    {"compute_com",  compute_com, METH_VARARGS, 
