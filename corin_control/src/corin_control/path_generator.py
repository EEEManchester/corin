...
x_cob = np.vstack((x_cob,np.array([0.02, 0.0, BODY_HEIGHT])))
x_cob = np.vstack((x_cob,np.array([0.04, 0.0, BODY_HEIGHT])))
x_cob = np.vstack((x_cob,np.array([0.08, 0.0, BODY_HEIGHT])))
...
# path = planner.generate_base_path(x_cob, w_cob, CTR_INTV, t_cob)
