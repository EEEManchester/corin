...
class CDDBackend(object):
  ...
  def build_polys(self, poly):
    """ Construct inner and outer polygon 
        Updates both polygon approximation from the previous run.
        Canonicalize to remove duplicates and implicit linearity """
