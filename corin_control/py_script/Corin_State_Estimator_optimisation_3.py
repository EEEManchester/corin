...
class CorinStateTester:
    def __init__(self):
        ...
        csv_file = './2019_optimisation_results_'+ str(exp_no) + '_3.csv'
        # copyfile(src, dst)
        src = './2019_optimisation_results_template_3.csv'
        ...
        Qw = [8E-8]
        Qbw = [7E-11]
        Qp_xy = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10]
        Qp_z = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10]
        Rs = [1E-5]
        Ra = [0.0003]
                                ...
                                for rs in Rs:
                                    for ra in Ra:
                                        for th in Th:
                                            ...
                                            self.estimator.Qp = np.diagflat([qp_xy, qp_xy, qp_z])
                                                ...
                                                if topic in callback_dict:
                                                    ...
                                                    if topic == '/vicon/corin/corin' or topic == '/vicon/Corin/Corin':
                                                        ...
                                                        if self.vicon_r is not None:
                                                            ...
                                                            error_ratio2 = np.linalg.norm(error2)/np.abs(self.vicon_angles[2])#np.linalg.norm(self.vicon_angles)
                                            ...
                                            error_row.append(qp_xy)
                                            error_row.append(qp_z)
                                            error_row.append(rs)
                                            error_row.append(ra)
                                            error_row.append(th)
