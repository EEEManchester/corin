...
class CorinStateTester:
    def __init__(self):
        ...
        csv_file = './2019_Jan_optimisation_results_'+ str(exp_no) + '.csv'
        # copyfile(src, dst)
        ...
        self.ideal_r = True # Use VICON position as estimate?
                                            ...
                                            if topic in callback_dict:
                                                ...
                                                if topic == '/vicon/corin/corin' or topic == '/vicon/Corin/Corin':
                                                    ...
                                                    if self.vicon_r is not None:
                                                        error = self.vicon_angles - self.estimator.get_fixed_angles()
