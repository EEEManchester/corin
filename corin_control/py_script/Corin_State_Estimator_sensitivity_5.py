...
class CorinStateTester:
    def __init__(self):
        ...
        csv_file = os.path.dirname(__file__) + '/2019_sensitivity_results_5/2019_sensitivity_results_'+ str(exp_no) + '_5.csv'
        # copyfile(src, dst)
        ...
        Qf = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        Qbf = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        Qw = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        Qbw = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        Qp = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        Rs = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        Ra = []
        Th = []

        p_r  = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        p_v  = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        p_q  = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        p_p  = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        p_bf = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
        p_bw = [1E10, 1E0, 1E-10, 1E-20, 1E-30]
