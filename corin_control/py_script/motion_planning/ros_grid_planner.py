...
from grid_map import GridMap as PyGridMap 					# grid map class
from path_planner import * 			# path planning class
from grid_map_msgs.msg import GridMap as RosGridMapMsg
from corin_control.srv import *
...
class GridMapRos:
	def __init__(self,map_name):
		...
		self.GridMap = PyGridMap(map_name)
