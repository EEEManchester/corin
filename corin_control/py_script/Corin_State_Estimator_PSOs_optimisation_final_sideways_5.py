...
class Particle():
    ...
    Q_lims = [Qf_lim, Qbf_lim, Qw_lim, Qbw_lim, Qp_lim, Rs_lim, Th_lim, Pbw_lim]
...
if __name__ == "__main__":
    ...
    csv_data_path = rospkg.RosPack().get_path('data') + "/PSO/PSO_final_sideways_5.csv"
