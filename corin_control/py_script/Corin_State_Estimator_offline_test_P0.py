...
class CorinStateTester:
    def __init__(self):
        ...
        self.evaluate_P0 = False # Initialise covariance matrix using sensor measurements
    ...
    def imu_callback(self, msg, t): 		# robot joint state callback
        ...
        if(True and self.cal_i  < self.cal_N):
            ...
            a = self.estimator.IMU_R.dot(np.mean(self.a0_array, axis=0)) # Transform to body frame
            ...
            bw = self.estimator.IMU_R.dot(np.mean(self.w_array, axis=0))
            ...
            if self.initialise_state:
                ...
                self.estimator.P[8, 8] = 1E-6 # we know heading = 0
            ...
            # print np.diag(self.estimator.P)
            # exit()
