...
class CorinStateTester:
    def __init__(self):
        ...
        csv_file = data_path + '/2019_sensitivity_results_8/2019_sensitivity_results_'+ str(exp_no) + '_8.csv'
        # copyfile(src, dst)
        ...
        self.initialise_state = False  # use IMU reading to initialise orientation and IMU bias states
        ...
        Qf = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10]
        Qbf = [1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10, 1E-11]
        Qw = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10, 1E-11]
        Qbw = [1E-6, 1E-7, 1E-8, 1E-9, 1E-10, 1E-11, 1E-12, 1E-13, 1E-14, 1E-15]
        Qp = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10]
        Rs = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9]
        Ra = []
        Th = []

        p_r  = [1E10, 1E5, 1E0, 1E-6, 1E-10]
        p_v  = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10, 1E-11]
        p_q  = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10, 1E-11]
        p_p  = []
        p_bf = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10, 1E-11]
        p_bw = [1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10, 1E-11, 1E-12, 1E-13]
        ...
        Q_list = [Qf, Qbf, Qw, Qbw, Qp, Rs, Ra, Th, p_r, p_v, p_q, p_p, p_bf, p_bw]
        ...
        for i in range (total_len):
            ...
            p_q  = new_Q_list[10][i]
            p_p  = new_Q_list[11][i]
            p_bf = new_Q_list[12][i]
            p_bw = new_Q_list[13][i]
