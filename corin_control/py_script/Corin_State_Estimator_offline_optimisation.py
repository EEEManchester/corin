...
class CorinStateTester:
    def __init__(self):
        ...
        csv_file = './2018_Dec_optimisation_results_'+ str(exp_no) + '.csv'
        # copyfile(src, dst)
        src = './2018_Dec_optimisation_results_template.csv'
        ...
        # Qf = [0.00025**2] #[0.00025**2]
        # Qbf = [0.1] #[0.001]
        # Qw = [6.4E-11] #[0.00008**2]
        # Qbw = [0.01] #[0.001]
        # Qp = [0.00000001]  #[0.001**2]
        # Rs = [1E-10] #[0.0001**2]
        # Ra = [0.01**2, 0.001**2, 0.0001**2]#0.00000001] #[0.0001**2]
    ...
    def vicon_callback(self, msg, t):
        ...
        if self.vicon_q0 is None:
            ...
            r -= self.vicon_r0
            r = quaternion_matrix(self.vicon_q0)[0:3,0:3].dot(r)
            self.vicon_r = r #np.vstack([self.vicon_r, r])
    ...
    def imu_callback(self, msg, t): 		# robot joint state callback
        ...
        if(True and self.cal_i  < self.cal_N):
            ...
            a = self.estimator.IMU_R.dot(a0) # Transform to body frame
